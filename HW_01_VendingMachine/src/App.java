...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        item1.setPrice(98.0);
        HotDrink coffee = new HotDrink("Coffee", 200.0, 0.7);
        coffee.setTemperature(80);
        HotDrink tea = new HotDrink("Tea", 50.0, 0.5);
        tea.setTemperature(100);
        ...
        itemMachin.addProduct(coffee);
        itemMachin.addProduct(tea);
